...
public class ShowDynamicQ7 extends javax.swing.JFrame {

    public ShowDynamicQ7() {
        initComponents();
        myconnection();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Τάξη", "Όνομα Μαθήματος", "Ημερομηνία/Ώρα"
            }
        ) {
    ...
    public final void myconnection () 
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowDynamicQ7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowDynamicQ7().setVisible(true);
            }
        });
    }
